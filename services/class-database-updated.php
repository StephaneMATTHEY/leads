...
class LC_Database {
    ...
    public static function create_tables() {
        ...
        // Table 4B : GROUP_CATEGORIES (relation many-to-many : groupes <-> catégories WordPress)
        $table_group_categories = $wpdb->prefix . 'lc_group_categories';
        $sql_group_categories = "CREATE TABLE IF NOT EXISTS $table_group_categories (
            group_id bigint(20) UNSIGNED NOT NULL,
            category_id bigint(20) UNSIGNED NOT NULL COMMENT 'ID de la catégorie WordPress',
            created_at datetime DEFAULT CURRENT_TIMESTAMP,
    ...
    public static function get_table_names() {
        ...
        return array(
            ...
            'group_categories' => $wpdb->prefix . 'lc_group_categories',
